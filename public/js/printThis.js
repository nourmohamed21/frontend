...
(function($) {
    ...
    function appendBody($body, $element, opt) {
        ...
        if (opt.printContainer) {
            ...
            $(`<div id='print-logo'></div>`).appendTo($body);
        } else {
    ...
    $.fn.printThis = function(options) {
        ...
        setTimeout(function() {
            ...
            if (opt.importCSS) $("link[rel=stylesheet]").each(function() {
                ...
                if (href&&href!="css/app-dark.css"&&href!="css/app-light.css") {
    ...
    $.fn.printThis.defaults = {
        ...
        loadCSS: [
            'css/Print.css',
            'css/style.css',
            // 'css/dataTables/buttons.bootstrap4.css',
            // 'css/dataTables/buttons.dataTables.css',
