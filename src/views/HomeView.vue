<template>
  <div class="wrapper" style="height: 100vh !important;width: 100vw !important;">
      ...
      <div class="inside-header">
        <div class="d-flex align-items-center logo-box justify-content-between">
          ...
          <a href="#" class="logo">
            <!-- logo-->
            <div class="logo-lg">
              <!-- <img src="!/images/System/logo-clear.png"  style="height: 7vh" alt="logo">  -->
              <img src="!/images/System/logo-text.png" style="height: 7vh" alt="logo">
    ...
    <nav class="main-nav" role="navigation">
      ...
      <ul id="main-menu" class="sm sm-blue sm-rtl">
        <li><a href="email_index.html"><i class="icon-Mail-notification"><span class="path1"></span><span
                class="path2"></span></i>Emails</a></li>
      </ul>
    </nav>

    <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper" style="background: #ECEEF7;">
